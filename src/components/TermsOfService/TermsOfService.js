...
const TermsOfService = props => {
  ...
  return (
    <div className={classes}>
      <p className={css.lastUpdated}>Dernère mise à jour : 19 octobre 2021</p>
      ...
      <p>
        Ce site web est exploité par Pealot. Sur ce site, les termes "nous", "notre" et "nos" font référence 
        à Pealot. Pealot propose ce site web, y compris toutes les informations, tous les outils et tous les 
        services qui y sont disponibles pour vous, l’utilisateur, sous réserve de votre acceptation de 
        l’ensemble des modalités, conditions, politiques et avis énoncés ici.
      </p>

      <p>
      En visitant ce site et/ou en achetant un de nos produits et services, vous vous engagez dans notre 
      "Service" et acceptez d’être lié par les modalités suivantes ("Conditions Générales de Service", 
        "Conditions Générales de Service et d’Utilisation", "Conditions Générales", "Conditions"), y compris 
      les modalités, conditions et politiques additionnelles auxquelles il est fait référence ici et/ou 
      accessibles par hyperlien. Ces Conditions Générales de Service et d’Utilisation s’appliquent à tous 
      les utilisateurs de ce site, incluant mais ne se limitant pas, aux utilisateurs qui naviguent sur le 
      site, qui sont des vendeurs, des clients, des marchands, et/ou des contributeurs de contenu.
      </p>
      ...
      ce site seront également assujettis à ces Conditions Générales de Service et d’Utilisation. Vous 
      pouvez consulter la version la plus récente des Conditions Générales de Service et d’Utilisation 
      à tout moment sur cette page. Nous nous réservons le droit de mettre à jour, de changer ou de remplacer 
      toute partie de ces Conditions Générales de Service et d’Utilisation en publiant les mises à jour et/ou 
      les modifications sur notre site web. Il vous incombe de consulter cette page régulièrement pour vérifier 
      si des modifications ont été apportées. Votre utilisation continue du site web ou votre accès à celui-ci 
      ...
      <p>
        L’utilisation de nos produits et services à toute fin illégale ou non autorisée est interdite, 
        et vous ne devez pas non plus, dans le cadre de l’utilisation du Service, violer les lois de 
        votre juridiction (incluant mais ne se limitant pas aux lois relatives aux droits d’auteur).
      </p>
      ...
      <p>
        Toute infraction ou violation des présentes Conditions Générales de Service et d’Utilisation 
      ...
      <p>
        Nous nous réservons le droit de refuser à tout moment l’accès aux services à toute personne, 
        et ce, pour quelque raison que ce soit.
      </p>

      <p>
        Vous comprenez que votre contenu (à l’exclusion de vos informations de carte de crédit) 
        pourrait être transféré de manière non chiffrée, et cela sous-entend (a) des transmissions 
        sur divers réseaux ; et (b) des changements pour se conformer et s’adapter aux exigences 
        techniques pour la connexion des réseaux ou appareils. Les informations de carte de crédit 
        sont toujours chiffrées pendant la transmission sur les réseaux.
      </p>

      <p>
        Vous acceptez de ne pas reproduire, dupliquer, copier, vendre, revendre ou exploiter une 
        quelconque partie du Service ou utilisation du Service, ou un quelconque accès au Service 
        ou contact sur le site web, par le biais duquel le Service est fourni, sans autorisation 
        écrite expresse préalable de notre part.
      </p>
      ...
      <p>
        Ce site pourrait contenir certaines informations antérieures. Ces informations antérieures, par 
        nature, ne sont pas à jour et sont fournies à titre indicatif seulement. Nous nous réservons le 
        droit de modifier le contenu de ce site à tout moment, mais nous n’avons aucune obligation de 
        mettre à jour les informations sur notre site. Vous acceptez qu’il vous incombe de surveiller 
        les modifications apportées à notre site.
      </p>
      ...
      <p>
        Nous ne serons pas responsables envers vous ou toute autre tierce partie de toute modification 
        de prix, suspension ou interruption du Service.
      </p>

      <h2>ARTICLE 5 – PRODUITS OU SERVICES</h2>

      <p>
        Certains produits ou services peuvent être exclusivement disponibles en ligne sur notre site web. 
        Ces produits ou services peuvent être disponibles en quantités limitées et peuvent uniquement faire 
        l’objet de remboursement conformément à notre Politique de Remboursement.
      </p>
      ...
      <p>
        Lorsque vous réservez un service, notamment l'utilisation d'une ou plusieurs place(s) de parc pour 
        une durée déterminée ou indéterminée, vous vous engagez à régler tous les frais liés à l'utilisation 
        de ce service, notamment via des paiements mensuels, afin de maintenir votre réservation active pour 
        la durée initialement réservée. Vous devez vous acquitter des frais mensuels d'utilisation de service 
        avant chaque mois pour lequel le service a été réservé. Dans le cas où un paiement ne serait pas 
        effectué avant le début d'un mois pour lequel le service a été réservé, votre réservation deviendrait 
        alors nulle, rendant ainsi votre utilisation du service initialement réservé non autorisée. 
      </p>

      <p>
        Nous nous réservons le droit, sans toutefois être obligés de le faire, de limiter les ventes de 
        nos produits ou services à toute personne, et dans toute région géographique ou juridiction. 
        Nous pourrions exercer ce droit au cas par cas. Nous nous réservons le droit de limiter les 
        quantités de tout produit ou service que nous offrons. Toutes les descriptions de produits/services 
        et tous les prix des produits/services peuvent être modifiés en tout temps sans avis préalable, 
        à notre seule discrétion. Nous nous réservons le droit d’arrêter d’offrir un produit ou un service 
        à tout moment. Toute offre de service ou de produit présentée sur ce site est nulle là où la loi 
        l’interdit.
      </p>
      ...
      <p>
        ...
        modifierions une commande ou si nous venions à l’annuler, nous pourrions tenter de vous 
        ...
        d’interdire les commandes qui, à notre seul jugement, pourraient sembler provenir de marchands, 
      ...
      <p>
        ...
        Ces nouvelles fonctionnalités et ces nouveaux services seront également assujettis à ces 
      ...
      <p>
        Certains contenus, produits et services disponibles par le biais de notre Service pourraient 
        inclure des éléments provenant de tierces parties.
      </p>
      ...
      <p>
        ...
        de biens, de services, de ressources, de contenu, ou de toute autre transaction effectuée 
        en rapport avec ces sites web de tiers. Veuillez lire attentivement les politiques et 
        pratiques des tierces parties et assurez-vous de bien les comprendre avant de vous engager 
        dans toute transaction. Les plaintes, réclamations, préoccupations, ou questions concernant 
        les produits et services de ces tiers doivent être soumises à ces mêmes tiers.
      </p>

      <h2>ARTICLE 9 – COMMENTAIRES, MESSAGES, SUGGESTIONS ET AUTRES PROPOSITIONS D’UTILISATEURS</h2>

      <p>
        Si, à notre demande, vous soumettez des contenus spécifiques (par exemple, pour participer à 
          des concours), ou si sans demande de notre part, vous envoyez des idées créatives, des 
        suggestions, des propositions, des plans ou d’autres éléments, que ce soit en ligne, par 
        e-mail, par courrier, ou autrement (collectivement, "commentaires et messages"), vous nous 
        accordez le droit, en tout temps, et sans restriction, d’éditer, de copier, de publier, 
        de distribuer, de traduire et d’utiliser autrement et dans tout média tout commentaire ou 
        message que vous nous envoyez. Nous ne sommes pas et ne devrons pas être tenus (1) de 
        maintenir la confidentialité des commentaires et messages ; (2) de payer une compensation 
        à quiconque pour tout commentaire ou message fourni ; (3) de répondre aux commentaires et 
        messages.
      </p>
      ...
      <p>
        Vous vous engagez à écrire des commentaires et messages qui ne violent pas les droits de tierces 
        parties, y compris les droits d’auteur, les marques déposées, la confidentialité, la personnalité, 
        ou d’autres droits personnels ou de propriété. Vous convenez également que vos commentaires et 
        messages ne contiendront pas de contenu illégal, diffamatoire, offensif ou obscène, et qu’ils ne 
        contiendront non plus pas de virus informatique ou d’autres logiciels malveillants qui pourraient 
        affecter de quelque manière que ce soit le fonctionnement du Service ou tout autre site web associé. 
        Vous ne pouvez pas utiliser de fausse adresse e-mail, prétendre être quelqu’un que vous n’êtes pas, 
        ou essayer de nous induire nous et/ou les tierces parties en erreur quant à l’origine de vos 
        commentaires et messages. Vous êtes entièrement responsable de tous les commentaires et messages 
        que vous publiez ainsi que de leur exactitude. Nous n’assumons aucune responsabilité et déclinons 
        tout engagement quant à tout commentaire ou message que vous publiez ou que toute autre tierce 
        partie publie.
      </p>
      ...
      <p>
        La soumission de vos renseignements personnels sur notre boutique est régie par notre 
        Politique de Confidentialité. Cliquez ici pour consulter notre Politique de Confidentialité.
      </p>
      ...
      <p>
        ...
        pourraient contenir des erreurs typographiques, des inexactitudes ou des omissions qui 
        pourraient être relatives aux descriptions de produits ou services, aux prix, aux promotions, 
        aux offres, aux frais d’expédition des produits et services, aux délais de livraison et à la 
        disponibilité. Nous nous réservons le droit de corriger toute erreur, inexactitude, omission, 
        et de changer ou de mettre à jour des informations ou d’annuler des commandes, si une quelconque 
        information dans le Service ou sur tout autre site web associé est inexacte, et ce, en tout temps 
        et sans préavis (y compris après que vous ayez passé votre commande).
      </p>
      ...
      <p>
        Nous ne garantissons pas que les résultats qui pourraient être obtenus par le biais de 
      ...
      <p>
        ...
        celui-ci, est à votre seul risque. Vous convenez également expressément que votre utilisation 
        du Service est légalement autorisée et que cette utilisation n'enfreint aucune loi ou règlement 
        (notamment communal(e), cantonal(e) ou fédéral(e)) en Suisse ou tout autre loi dans le pays, 
        État ou toute région géographique ou juridiction où vous vous trouvez ainsi que dans le pays, 
        État ou toute région géographique ou juridiction dans lequel le Service est fourni ou utilisé. 
        Vous vous devez de vous tenir informé(e) des dispositions légales appliquées dans la commune, 
        le canton (ou la région) ainsi que l'État ou toute région géographique ou juridiction dans 
        laquelle vous vous trouvez et ceux dans lesquels le Service est fourni ou utilisé, notamment 
        concernant, mais ne se limitant pas à ces cas, les autorisations, les taxes, impôts et autres 
        dédommagements liés à l'utilisation de biens immobiliers par des tiers dont vous devez vous 
        acquitter, les règles et lois régissant l'utilisation, la location et la sous-location de 
        biens immobiliers, et convenez expressément être responsable de tout utilisation du Service, 
        que celle-ci soit autorisée, non autorisée, légale ou illégale. Le Service ainsi que tous les 
        produits et services qui vous sont fournis par le biais du Service sont (sauf mention expresse 
          du contraire de notre part) fournis "tels quels" et "selon la disponibilité" pour votre 
        utilisation, et ce sans représentation, sans garanties et sans conditions d'aucune sorte, 
        expresses ou implicites, y compris toutes les garanties implicites de commercialisation ou 
        de qualité marchande, d’adaptation à un usage particulier, de durabilité, de titre et d’absence 
        de contrefaçon.
      </p>
      ...
      <p>
        Si nous jugeons, à notre seule discrétion, que vous échouez, ou si nous soupçonnons que vous 
        avez été incapable de vous conformer aux modalités de ces Conditions Générales de Service 
        et d’Utilisation, nous pourrions aussi résilier cet accord à tout moment sans vous prévenir 
        à l’avance et vous resterez responsable de toutes les sommes redevables jusqu’à la date de 
        résiliation (celle-ci étant incluse), et/ou nous pourrions vous refuser l’accès à nos Services 
      ...
      <p>
        ...
        disposition des présentes Conditions Générales de Service et d’Utilisation ne devrait 
        pas constituer une renonciation à ce droit ou à cette disposition.
      </p>
      ...
      <p>
        Toute ambiguïté quant à l’interprétation de ces Conditions Générales de Service et d’Utilisation 
        ne doit pas être interprétée en défaveur de la partie rédactrice.
      </p>

      <h2>ARTICLE 18 – LOI APPLICABLE</h2>

      <p>
        Ces Conditions Générales de Service et d’Utilisation, ainsi que tout autre accord séparé par le 
        biais duquel nous vous fournissons des Services seront régis et interprétés en vertu des lois en 
        vigueur à Lausanne en Suisse.
      </p>

      <h2>ARTICLE 19 – MODIFICATIONS APPORTÉES AUX CONDITIONS GÉNÉRALES DE SERVICE ET D’UTILISATION</h2>

      <p>
        Vous pouvez consulter la version la plus récente des Conditions Générales de Service et d’Utilisation 
