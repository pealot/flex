...
const TermsOfService = props => {
  ...
  return (
    <div className={classes}>
      ...
      <p align="justify"> 
      "Ce site web est exploité par Pealot. Sur ce site, les termes “nous”, “notre” et “nos” font référence à Pealot. Pealot propose ce site web, y compris toutes les informations, tous les outils et tous les services qui y sont disponibles pour vous, l’utilisateur, sous réserve de votre acceptation de l’ensemble des modalités, conditions, politiques et avis énoncés ici." 
      </p>

      <p align="justify"> 
      En visitant ce site et"/"ou en achetant un de nos produits et services, vous vous engagez dans notre “Service” et acceptez d’être lié par les modalités suivantes (“Conditions Générales de Service”, “Conditions Générales de Service et d’Utilisation”, “Conditions Générales”, “Conditions”), y compris les modalités, conditions et politiques additionnelles auxquelles il est fait référence ici et/ou accessibles par hyperlien. Ces Conditions Générales de Service et d’Utilisation s’appliquent à tous les utilisateurs de ce site, incluant mais ne se limitant pas, aux utilisateurs qui naviguent sur le site, qui sont des vendeurs, des clients, des marchands, et/ou des contributeurs de contenu.
      </p>
      ...
      <p align="justify"> 
      "Toutes les nouvelles fonctionnalités et tous les nouveaux outils qui seront ajoutés ultérieurement à ce site seront également assujettis à ces Conditions Générales de Service et d’Utilisation. Vous pouvez consulter la version la plus récente des Conditions Générales de Service et d’Utilisation à tout moment sur cette page. Nous nous réservons le droit de mettre à jour, de changer ou de remplacer toute partie de ces Conditions Générales de Service et d’Utilisation en publiant les mises à jour et/ou les modifications sur notre site web. Il vous incombe de consulter cette page régulièrement pour vérifier si des modifications ont été apportées. Votre utilisation continue du site web ou votre accès à celui-ci après la publication de toute modification constitue une acception de votre part de ces modifications."
      </p>
      ...
      <p align="justify"> 
        "L’utilisation de nos produits et services à toute fin illégale ou non autorisée est interdite, et vous ne devez pas non plus, dans le cadre de l’utilisation du Service, violer les lois de votre juridiction (incluant mais ne se limitant pas aux lois relatives aux droits d’auteur)."
      </p>
      ...
      <p align="justify"> 
        "Toute infraction ou violation des présentes Conditions Générales de Service et d’Utilisation entraînera la résiliation immédiate de vos Services."
      </p>
      ...
      <p align="justify"> 
        "Certains produits ou services peuvent être exclusivement disponibles en ligne sur notre site web. Ces produits ou services peuvent être disponibles en quantités limitées et peuvent uniquement faire l’objet de remboursement conformément à notre Politique de Remboursement."
      </p>
      ...
      <p align="justify"> 
        "Lorsque vous réservez un service, notamment l'utilisation d'une ou plusieurs place(s) de parc pour une durée déterminée ou indéterminée, vous vous engagez à régler tous les frais liés à l'utilisation de ce service, notamment via des paiements mensuels, afin de maintenir votre réservation active pour la durée initialement réservée. Vous devez vous acquitter des frais mensuels d'utilisation de service avant chaque mois pour lequel le service a été réservé. Dans le cas où un paiement ne serait pas effectué avant le début d'un mois pour lequel le service a été réservé, votre réservation deviendrait alors nulle, rendant ainsi votre utilisation du service initialement réservé non autorisée."
      </p>

      <p align="justify"> 
        Nous nous réservons le droit, sans toutefois être obligés de le faire, de limiter les ventes de nos produits ou services à toute personne, et dans toute région géographique ou juridiction. Nous pourrions exercer ce droit au cas par cas. Nous nous réservons le droit de limiter les quantités de tout produit ou service que nous offrons. Toutes les descriptions de produits/services et tous les prix des produits/services peuvent être modifiés en tout temps sans avis préalable, à notre seule discrétion. Nous nous réservons le droit d’arrêter d’offrir un produit ou un service à tout moment. Toute offre de service ou de produit présentée sur ce site est nulle là où la loi l’interdit.
      </p>
      ...
      <p align="justify"> 
        "Nous pourrions aussi, à l’avenir, offrir de nouveaux services et"/"ou de nouvelles fonctionnalités sur notre site (incluant de nouveaux outils et de nouvelles ressources). Ces nouvelles fonctionnalités et ces nouveaux services seront également assujettis à ces Conditions Générales de Service et d’Utilisation."
      </p>
      ...
      <p align="justify"> 
        "Nous ne sommes pas responsables des préjudices ou dommages liés à l’achat ou à l’utilisation de biens, de services, de ressources, de contenu, ou de toute autre transaction effectuée en rapport avec ces sites web de tiers. Veuillez lire attentivement les politiques et pratiques des tierces parties et assurez-vous de bien les comprendre avant de vous engager dans toute transaction. Les plaintes, réclamations, préoccupations, ou questions concernant les produits et services de ces tiers doivent être soumises à ces mêmes tiers."
      </p>

      <h2>ARTICLE 9 – COMMENTAIRES, MESSAGES, SUGGESTIONS ET AUTRES PROPOSITIONS D’UTILISATEURS</h2>

      <p align="justify"> 
        "Si, à notre demande, vous soumettez des contenus spécifiques (par exemple, pour participer à des concours), ou si sans demande de notre part, vous envoyez des idées créatives, des suggestions, des propositions, des plans ou d’autres éléments, que ce soit en ligne, par e-mail, par courrier, ou autrement (collectivement, “commentaires et messages”), vous nous accordez le droit, en tout temps, et sans restriction, d’éditer, de copier, de publier, de distribuer, de traduire et d’utiliser autrement et dans tout média tout commentaire ou message que vous nous envoyez. Nous ne sommes pas et ne devrons pas être tenus (1) de maintenir la confidentialité des commentaires et messages ; (2) de payer une compensation à quiconque pour tout commentaire ou message fourni ; (3) de répondre aux commentaires et messages."
      </p>
      ...
      <p align="justify"> 
        "Vous vous engagez à écrire des commentaires et messages qui ne violent pas les droits de tierces parties, y compris les droits d’auteur, les marques déposées, la confidentialité, la personnalité, ou d’autres droits personnels ou de propriété. Vous convenez également que vos commentaires et messages ne contiendront pas de contenu illégal, diffamatoire, offensif ou obscène, et qu’ils ne contiendront non plus pas de virus informatique ou d’autres logiciels malveillants qui pourraient affecter de quelque manière que ce soit le fonctionnement du Service ou tout autre site web associé. Vous ne pouvez pas utiliser de fausse adresse e-mail, prétendre être quelqu’un que vous n’êtes pas, ou essayer de nous induire nous et/ou les tierces parties en erreur quant à l’origine de vos commentaires et messages. Vous êtes entièrement responsable de tous les commentaires et messages que vous publiez ainsi que de leur exactitude. Nous n’assumons aucune responsabilité et déclinons tout engagement quant à tout commentaire ou message que vous publiez ou que toute autre tierce partie publie."
      </p>
      ...
      <p align="justify"> 
        "Vous convenez expressément que votre utilisation du Service, ou votre incapacité à utiliser celui-ci, est à votre seul risque. Vous convenez également expressément que votre utilisation du Service est légalement autorisée et que cette utilisation n'enfreint aucune loi ou règlement (notamment communal(e), cantonal(e) ou fédéral(e)) en Suisse ou tout autre loi dans le pays, État ou toute région géographique ou juridiction où vous vous trouvez ainsi que dans le pays, État ou toute région géographique ou juridiction dans lequel le Service est fourni ou utilisé. Vous vous devez de vous tenir informé(e) des dispositions légales appliquées dans la commune, le canton (ou la région) ainsi que l'État ou toute région géographique ou juridiction dans laquelle vous vous trouvez et ceux dans lesquels le Service est fourni ou utilisé, notamment concernant, mais ne se limitant pas à ces cas, les autorisations, les taxes, impôts et autres dédommagements liés à l'utilisation de biens immobiliers par des tiers dont vous devez vous acquitter, les règles et lois régissant l'utilisation, la location et la sous-location de biens immobiliers, et convenez expressément être responsable de tout utilisation du Service, que celle-ci soit autorisée, non autorisée, légale ou illégale. Le Service ainsi que tous les produits et services qui vous sont fournis par le biais du Service sont (sauf mention expresse du contraire de notre part) fournis “tels quels” et “selon la disponibilité” pour votre utilisation, et ce sans représentation, sans garanties et sans conditions d'aucune sorte, expresses ou implicites, y compris toutes les garanties implicites de commercialisation ou de qualité marchande, d’adaptation à un usage particulier, de durabilité, de titre et d’absence de contrefaçon."
      </p>
      ...
      <p align="justify"> 
        "Ces Conditions Générales de Service et d’Utilisation sont effectives à moins et jusqu’à ce qu’elles soient résiliées par ou bien vous ou non. Vous pouvez résilier ces Conditions Générales de Service et d’Utilisation à tout moment en nous avisant que vous ne souhaitez plus utiliser nos Services, ou lorsque vous cessez d’utiliser notre site."
      </p>
      ...
      <p align="justify"> 
        "Tout manquement de notre part à l’exercice ou à l’application de tout droit ou de toute disposition des présentes Conditions Générales de Service et d’Utilisation ne devrait pas constituer une renonciation à ce droit ou à cette disposition."
      </p>
      ...
      <p align="justify"> 
        "Toute ambiguïté quant à l’interprétation de ces Conditions Générales de Service et d’Utilisation ne doit pas être interprétée en défaveur de la partie rédactrice."
      </p>

      <h2>ARTICLE 18 – LOI APPLICABLE</h2>

      <p align="justify"> 
        "Ces Conditions Générales de Service et d’Utilisation, ainsi que tout autre accord séparé par le biais duquel nous vous fournissons des Services seront régis et interprétés en vertu des lois en vigueur à Lausanne en Suisse."
      </p>

      <h2>ARTICLE 19 – MODIFICATIONS APPORTÉES AUX CONDITIONS GÉNÉRALES DE SERVICE ET D’UTILISATION</h2>

      <p align="justify"> 
        "Vous pouvez consulter la version la plus récente des Conditions Générales de Service et d’Utilisation à tout moment sur cette page."
      </p>
